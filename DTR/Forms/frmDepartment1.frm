...
Begin VB.Form frmDepartment 
   ...
   Begin MSComctlLib.ImageList i16x16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDepartment1.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDepartment1.frx":059A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDepartment1.frx":0B34
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDepartment1.frx":10CE
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDepartment1.frx":1848
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmDepartment1.frx":4C56
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Label lblTitle 
      ...
      Caption         =   "Deparment's  Masterlist"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
...
On Error Resume Next
srcDepartment = lvList.SelectedItem.Index
srcRecord = lvList.ListItems.Item(srcDepartment).Text
End Sub
...
Set RS_Department = New ADODB.Recordset
If RS_Department.State = adStateOpen Then RS_Department.Close
RS_Department.Open srcSQL, conn, adOpenDynamic, adLockOptimistic
Call FillListview
...
Select Case srcPerformWhat
    ...
    Case "Delete" 'Delete
            ...
            If MsgBox("Are you sure you want to delete" & Space(1) & lvList.SelectedItem.SubItems(1) & "?", vbCritical + vbYesNo, Me.Caption) = vbYes Then
                SQL_DELETE "DELETE FROM Department WHERE name='" & srcRecord & "'"
...
With lvList
    ...
    .ListItems.Clear
    Do While Not RS_Department.EOF
        Set lvItem = .ListItems.Add(, , RS_Department.Fields("Name"), 1, 1)
            lvItem.SubItems(1) = RS_Department.Fields("Description")
