...
Begin VB.Form frmCorporation 
   ...
   Begin MSComctlLib.ImageList i16x16 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCorporation.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCorporation.frx":059A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCorporation.frx":0B34
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCorporation.frx":10CE
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCorporation.frx":1848
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCorporation.frx":4C56
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Label lblTitle 
      ...
      Caption         =   "Corporation  Masterlist"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
...
srcSQL = "SELECT Corporation.* " & _
            " FROM Corporation " & _
            " ORDER BY Corporation.Name ASC "

Set RS_Corporation = New ADODB.Recordset
If RS_Corporation.State = adStateOpen Then RS_Corporation.Close
RS_Corporation.Open srcSQL, conn, adOpenDynamic, adLockPessimistic
...
On Error Resume Next
srcCorporation = lvList.SelectedItem.Index
srcRecord = lvList.ListItems.Item(srcCorporation).Text
End Sub
...
Set RS_Corporation = New ADODB.Recordset
If RS_Corporation.State = adStateOpen Then RS_Corporation.Close
RS_Corporation.Open srcSQL, conn, adOpenDynamic, adLockOptimistic
Call FillListview
...
Select Case srcPerformWhat
    ...
    Case "Delete" 'Delete
            ...
            If MsgBox("Are you sure you want to delete" & Space(1) & lvList.SelectedItem.SubItems(1) & "?", vbCritical + vbYesNo, Me.Caption) = vbYes Then
                SQL_DELETE "DELETE FROM Corporation WHERE name='" & srcRecord & "'"
...
With lvList
    ...
    .ListItems.Clear
    Do While Not RS_Corporation.EOF
        Set lvItem = .ListItems.Add(, , RS_Corporation.Fields("Name"), 1, 1)
            lvItem.SubItems(1) = RS_Corporation.Fields("Description")
        RS_Corporation.MoveNext
    Loop
End With
End Sub
