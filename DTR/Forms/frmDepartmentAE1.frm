VERSION 5.00
Begin VB.Form frmDepartmentAE1 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image1 
         Height          =   870
         Left            =   0
         Picture         =   "frmDepartmentAE1.frx":0000
         Top             =   0
         Width           =   1155
      End
   End
   ...
   End
End
Attribute VB_Name = "frmDepartmentAE1"
...
Dim obj As Control
            ...
            If State = AddStateMode Then
                ...
                MsgBox "New Departments unit has been successfully saved!", vbInformation, Me.Caption
                Unload Me
