VERSION 5.00
Begin VB.Form frmDesignationAE 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image1 
         Height          =   870
         Left            =   0
         Picture         =   "frmDesignationAE.frx":0000
         Top             =   0
         Width           =   1155
      End
   End
   ...
   End
End
Attribute VB_Name = "frmDesignationAE"
...
Dim obj As Control
            ...
            If State = AddStateMode Then
                ...
                SQL_INSERT "INSERT INTO Designation (Name, Description) VALUES ('" & txtUnitCD.Text & "', '" & txtDescription.Text & "')"
                MsgBox "New Designations unit has been successfully saved!", vbInformation, Me.Caption
                Unload Me
            
            Else

                Set RS_Designation = New ADODB.Recordset
                SQL_UPDATE "UPDATE Designation SET Description= '" & txtDescription.Text & "' WHERE Name='" & txtUnitCD.Text & "'"
...
On Error GoTo err
CenterForm frmDesignationAE

If State = AddStateMode Then
    Me.Caption = "Create New Entry"
Else

    strSQL = "SELECT Designation.* " & _
            "FROM Designation " & _
            "WHERE (((Designation.Name)='" & PK & "'))"

    Set RS_Designation = New ADODB.Recordset
    If RS_Designation.State = adStateOpen Then RS_Designation.Close
    RS_Designation.Open strSQL, conn, adOpenDynamic, adLockOptimistic
...
Set frmDesignationAE = Nothing
frmDesignation.CommandPass "Refresh"
End Sub
